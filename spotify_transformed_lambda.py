...
def lambda_handler(event, context):
    ...
    for data in spotify_data:
        ...
        album_key = "processed_data/albums_processed/album_transformed_" + str(datetime.now()) + ".csv"
        ...
        artist_key = "processed_data/artist_processed/artist_transformed_" + str(datetime.now()) + ".csv"
        ...
        song_key = "processed_data/songs_processed/songs_transformed_" + str(datetime.now()) + ".csv"
    ...
    for key in spotify_keys:
        ...
        s3_resource.meta.client.copy(copy_source, Bucket, 'raw_data/processed_staging/' + key.split("/")[-1])
